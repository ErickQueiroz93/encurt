                        ...
                        <div class="formly-field ng-scope ng-isolate-scope formly-field-fieldUsername">
                          <div class="ng-scope form-group">
                            <div class="input-group">
                              <input class="form-control ng-pristine ng-untouched ng-valid ng-not-empty ng-valid-required ng-valid-maxlength ng-valid-email" disabled="true" placeholder="" required>
                              <div class="input-group-addon ng-scope" ng-if="to.addonRight" ng-style="{cursor: to.addonRight.onClick ? 'pointer' : 'inherit'}" ng-click="to.addonRight.onClick(options, this)" role="button" tabindex="0" style="cursor: pointer;">
                              </div>
                            </div>
                          </div>
                        </div >
